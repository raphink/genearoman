\documentclass[$if(fontsize)$$fontsize$,$endif$$if(lang)$$lang$,$endif$,openright,twoside,mcrownvopaper,
showtrims
]{$documentclass$}
...
\newfontfamily\chapfont[Scale=1]{Open Sans Condensed Light}
\newfontfamily\chapnumbfont[Numbers=OldStyle]{Linux Biolinum O}
%\newfontfamily\secfont[Scale=1]{Open Sans Condensed Light}
\newfontfamily\secfont{IM FELL FLOWERS 2}
\setsecheadstyle{\center\secfont\large n}
